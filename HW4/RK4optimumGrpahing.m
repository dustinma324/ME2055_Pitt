...
hold on
title("RK4 optimum \Delta \eta")
xlabel('log(\eta)')
ylabel('log(error)')
clear all;
end
figure(1);legend("f^{'}(\infty)",'\Delta\eta=0.9','\Delta\eta=0.7','\Delta\eta=0.5','\Delta\eta=0.2','location','southeast')
figure(2);legend('\Delta\eta=0.9','\Delta\eta=0.7','\Delta\eta=0.5','\Delta\eta=0.2','location','southwest')